...
import registerArtwork from '../../assets/register.png'
    ...
    <main className="flex min-h-full items-center justify-center px-4 py-6 sm:py-8">
      <section className="relative isolate w-full max-w-6xl overflow-hidden rounded-sm border border-[#c084fc]/12 shadow-[0_24px_64px_rgba(5,5,16,0.42)]">
        <img
          ...
          src={registerArtwork}
        />
        <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(5,5,16,0.54)_0%,rgba(5,5,16,0.3)_36%,rgba(5,5,16,0.74)_100%)]" />
        ...
        <div className="relative grid min-h-[620px] items-center px-4 py-6 sm:px-6 lg:grid-cols-[420px_minmax(0,1fr)] lg:px-8">
          ...
          >
            <div className="space-y-2">
              <p className="text-[11px] uppercase tracking-[0.28em] text-[#d4b8ff]">Area registrazione</p>
              <h1 className="text-3xl font-bold text-white">Register</h1>
              <p className="text-[#ddd6fe]">Crea il tuo account e torna subito alla home.</p>
            </div>

            <label className="flex flex-col gap-2">
              <span className="text-sm text-[#f5f3ff]">Username</span>
              <input
              ...
              />
              {errors.username ? <span className="text-sm text-red-300">{errors.username.message}</span> : null}
            </label>
